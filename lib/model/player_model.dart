...
class PlayerModel extends UserModel {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'about': about,
      'liked': isLiked,
      'totalRateSkil': totalRateSkil.toMap(),
      'averageRateSkil': averageRateSkil.toMap(),
  ...
  factory PlayerModel.fromMap(Map<String, dynamic> map) {
    return PlayerModel(
        ...
        totalRateSkil: RateSkilModel.fromMap(map['totalRateSkil']),
        averageRateSkil: RateSkilModel.fromMap(map['averageRateSkil']),
